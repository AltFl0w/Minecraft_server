...
export class AICaretakerManager {
    ...
    update() {
        ...
        if (currentTick - this.lastUpdate < 20)
            return;
    ...
    assignTasks() {
        ...
        for (const task of this.tasks) {
            if (task.assignedCaretaker || task.completed)
                continue;
