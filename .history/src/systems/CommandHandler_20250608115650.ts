...
import { PermissionManager, PlayerRole } from './PermissionManager';
...
export class CommandHandler {
    ...
    handleCommand(player: Player, message: string): void {
    ...
    private handleRoleCommand(player: Player, params: string[]): void {
        if (params.length === 0) {
            const role = this.permissionManager.getPlayerRole(player);
    ...
    private handlePromoteCommand(player: Player, params: string[]): void {
        if (params.length < 2) {
        ...
        const newRole = params[1].toLowerCase() as PlayerRole;
    ...
    private handleConfigCommand(player: Player, params: string[]): void {
    ...
    private handleZooCommand(player: Player, params: string[]): void {
    ...
    private handleAICommand(player: Player, params: string[]): void {
    ...
    private handleExhibitCommand(player: Player, params: string[]): void {
        if (params.length === 0) {
